...
class WeeklyAgencyReport extends StatefulWidget {
  const WeeklyAgencyReport({super.key});

  @override
  State<WeeklyAgencyReport> createState() => _WeeklyAgencyReportState();
}

class _WeeklyAgencyReportState extends State<WeeklyAgencyReport> {
  DateTime? startDate;
  DateTime? endDate;
