...
class IconImageClass{
  ...
  Widget get arrowDropUpOutlined =>  const CustomSvgPictures.asset("$iconPath/arrow_drop_up_outlined.svg", fit: BoxFit.cover,colorFilter: ColorFilter.mode(kWhiteColor,BlendMode.srcIn),);
